...
export default function Header() {
  ...
  return (
    <div className="relative">
      <NavbarTop />
      <nav className="xlHeader:container w-full block mx-auto px-4 py-2 
      xlHeader:bg-white bg-[#0156FF] relative z-10">
        <div className="flex items-center justify-between container mx-auto px-2 gap-4">
          ...
          <div className="flex items-center w-full bg-white p-2 py-1 rounded-full">
            <Magnfier />
            <input className="w-full p-2 focus:outline-0 focus:border-0 bg-transparent" type="search" placeholder="Search Here" />
          </div>
        ...
        <Logo />
          <ul className="flex justify-center items-center px-2">
            ...
            <button
              className="py-1 transition-all px-5 rounded-2xl font-semibold text-[#0156FF] mx-2 hover:bg-[#0156FF] hover:text-white border-2 border-solid border-secondaryBlue"
            >
              Our Deals
            </button>
          </ul>
