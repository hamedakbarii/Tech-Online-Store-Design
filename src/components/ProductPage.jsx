...
import { ArrowDown, Comparison, GraphicRtxIcon, HeartLike, IntelIconSvg, LongArrow, NovelLetter, PayPalIconSvg, ZipIcon } from "./Icon";
...
let AboutProduct = () => {
    ...
    <div className="flex items-center gap-4 px-4 mt-4">
        <div className="p-[.05rem] border-2 border-secondaryBlue rounded-full flex items-center justify-center">
            <div className="w-10 h-10 bg-[#4B4D4F] rounded-full">

            </div>
        </div>
        <div className="p-[.05rem] border-2 border-transparent rounded-full flex items-center justify-center">
            <div className="w-10 h-10 bg-[#EAE8EB] rounded-full">

            </div>
        </div>
        <div className="p-[.05rem] border-2 border-transparent rounded-full flex items-center justify-center">
            <div className="w-10 h-10 bg-[#F2E9DC] rounded-full">
            ...
            */}
                    ...
                    <div className="flex items-center justify-between gap-4 mt-4">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="flex flex-col">
                                <span onClick={()=>{setProductCount(productCount + 1)}} className="rotate-[180deg] p-2"><ArrowDown color="gray" size="10" /></span>
                                <span onClick={()=>{
                                    if (productCount <=1) {
                                        return null
                                    }else { 
            ...
            <div className="relative grid grid-cols-1 grid-rows-[1.5fr_1fr] pb-6">
                ...
                <div className="clip-path-inset0 relative">
                    <img className="w-full h-full fixed top-0 left-0 object-cover" src="./assets/Cpu/intelCpu.png" />
                </div>
            ...
            <div className="px-4 flex flex-col items-center justify-center py-6 gap-8 lineargradiant text-white">
                ...
                <div className="flex flex-col items-center justify-center gap-4">
                    ...
                    <p className="text-center">
                        <span className="font-semibold">Intel® Core™ i7</span> processor with the upmost computing power to bring you an unparalleled gaming experience.
                    </p>
                </div>
                <div className="flex flex-col items-center justify-center gap-4">
                    <div className="w-20 h-20 flex items-center justify-center bg-black rounded-full">
                    ...
                    <p className="text-center">
                        The new <span className="font-semibold">GeForce® RTX SUPER™</span> Series has more cores and higher clocks for superfast performance compared to previous-gen GPUs.
                    </p>
                </div>
                <div className="flex flex-col items-center justify-center gap-4">
                    <div className="w-20 h-20 flex items-center justify-center bg-black rounded-full">
