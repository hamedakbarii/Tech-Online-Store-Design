  ...
  return (
    <div className="flex flex-col container mx-auto">
      <div className="flex items-center gap-2 px-2">
        ...
        <span className="text-secondaryBlue font-semibold text-lg">{">"}</span>
        <span className="block">About Us</span>
      </div>
      <h1 className="text-2xl font-bold mt-4 px-2">About Us</h1>
      <div className="grid grid-rows-[auto_1fr] bg-gray-200 mt-4">
        <div className="flex items-center justify-center h-full">
          <img
            src="./assets/ShopTable.png"
      ...
      <div className="grid grid-rows-[auto_1fr] bg-black pt-6">
        <div className="flex items-center justify-center h-full">
          <img
            src="./assets/MostCreativeCase.png"
            className="object-center object-cover"
          />
        </div>
        <div className="flex flex-col p-4 px-6 text-white">
